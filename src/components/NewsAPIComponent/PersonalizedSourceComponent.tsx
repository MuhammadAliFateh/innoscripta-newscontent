...
import { getPersonalizedNewsAPISources} from "../../api/NewsAPI";
...
const PersonalizedSourceComponent = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      let resp = await getPersonalizedNewsAPISources(localSourceItem);
...
export default PersonalizedSourceComponent;
